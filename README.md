...
* [x] feed_dict строить в зависимости от мода, который может принимать три значения: {"train", "validation", "test"}: 
"train" - очевидно, 
"validation" - нужны лейблы для лоса, но не нужны дропауты,
